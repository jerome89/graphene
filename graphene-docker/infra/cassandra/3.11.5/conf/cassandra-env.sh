...
JVM_OPTS="$JVM_OPTS -Xloggc:/var/log/cassandra/gc_log/gc.log"
...
## which delegates to the IAuthenticator configured in cassandra.yaml.tmpl. See the sample JAAS configuration
...
JVM_OPTS="$JVM_OPTS -Dcassandra.max_queued_native_transport_requests=8192"
