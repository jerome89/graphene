...
public class SummarizeFunction extends GrapheneFunction {
    ...
    public List<TimeSeries> evaluate(TargetEvaluator evaluator) throws EvaluationException {
        // parse interval
        int step = (int) Math.abs(DateTimeUtils.INSTANCE.parseTimeOffset((String) arguments.get(1)));
    ...
    public void checkArguments() throws InvalidArgumentException {
        ...
        if (!DateTimeUtils.INSTANCE.testTimeOffset((String) arguments.get(1))) throw new InvalidArgumentException("summarize: interval cannot be parsed (" + arguments.get(1) + ")");
