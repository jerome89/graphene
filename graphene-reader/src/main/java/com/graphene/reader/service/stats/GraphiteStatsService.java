package com.graphene.reader.service.stats;

import com.google.common.util.concurrent.AtomicDouble;
import com.graphene.reader.config.StatsConfiguration;
 ...
 */
public class GraphiteStatsService implements StatsService {

    private Logger logger = LogManager.getLogger(GraphiteStatsService.class);
    ...
    public GraphiteStatsService(StatsConfiguration statsConfiguration) {
    ...
    private synchronized void flush() {
        ...
        try {
            ...
            for (Map.Entry<String, StatsRecord> entry : statsToFlush.entrySet()) {
                ...
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".render_requests " + statsRecord.getRenderRequests() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".render_paths_read " + statsRecord.getRenderPathsRead() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".render_points_read " + statsRecord.getRenderPointsRead() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".paths_requests " + statsRecord.getPathsRequests() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".throttled " + statsRecord.getThrottled() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
                dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.tenants." + tenant + ".timed_out_requests " + statsRecord.getTimedOutRequests() + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            }

            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.render_requests " + totalRenderRequests + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.render_paths_read " + totalRenderPathsRead + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.render_points_read " + totalRenderPointsRead + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.paths_requests " + totalPathsRequests + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.throttled " + totalThrottled + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
            dos.writeBytes(statsConfiguration.getHostname() + ".graphene-reader.timed_out_requests " + totalTimedOutRequests + " " + timestamp + " " + statsConfiguration.getTenant() + "\n");
