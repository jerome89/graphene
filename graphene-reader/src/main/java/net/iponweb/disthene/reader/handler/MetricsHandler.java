...
public class MetricsHandler implements DistheneReaderHandler {
    ...
    public MetricsHandler(CassandraMetricService cassandraMetricService) {
        this.cassandraMetricService = cassandraMetricService;
    }
    ...
    public FullHttpResponse handle(HttpRequest request) throws ParameterParsingException, ExecutionException, InterruptedException, TooMuchDataExpectedException {
        ...
        FullHttpResponse response = new DefaultFullHttpResponse(
                ...
                Unpooled.wrappedBuffer(cassandraMetricService.getMetricsAsJson(parameters.getTenant(), parameters.getPath(), parameters.getFrom(), parameters.getTo()).getBytes()));
