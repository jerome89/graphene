...
public class PathStatsHandler implements DistheneReaderHandler {
    ...
    public PathStatsHandler(ElasticsearchIndexService elasticsearchIndexService, StatsService statsService) {
    ...
    public FullHttpResponse handle(HttpRequest request) throws ParameterParsingException, TooMuchDataExpectedException {
        ...
        String pathsAsJsonArray = elasticsearchIndexService.getPathsWithStats(parameters.getTenant(), parameters.getQuery());
