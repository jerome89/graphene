...
public class DistheneReader {
    ...
    private void run() {
        try {
            ...
            elasticsearchIndexService = new ElasticsearchIndexService(distheneReaderConfiguration.getIndex());
            ...
            cassandraMetricService = new CassandraMetricService(elasticsearchIndexService, cassandraService, statsService, distheneReaderConfiguration);
            ...
            readerServer.registerHandler(METRICS_FIND_PATH, new MetricsFindHandler(elasticsearchIndexService));
            ...
            RenderHandler renderHandler = new RenderHandler(cassandraMetricService, elasticsearchIndexService, statsService, throttlingService, distheneReaderConfiguration.getReader());
