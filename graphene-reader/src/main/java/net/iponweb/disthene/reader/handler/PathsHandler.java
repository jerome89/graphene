...
public class PathsHandler implements DistheneReaderHandler {
    ...
    public PathsHandler(ElasticsearchIndexService elasticsearchIndexService, StatsService statsService) {
    ...
    public FullHttpResponse handle(HttpRequest request) throws ParameterParsingException, TooMuchDataExpectedException {
        ...
        String pathsAsJsonArray = elasticsearchIndexService.getPathsAsJsonArray(parameters.getTenant(), parameters.getQuery());
